import { dimensionIds } from "./dimensions.js";
...
export const VTDT_SOURCES = Object.freeze({
  ...
  openDays2025:
    "https://www.vtdt.lv/single-post/profesiju-atv%C4%93rto-durvju-dienas-2025",
});

// Mainot piedāvājumu nākamajam gadam, profesiju pieejamība jālabo tikai šeit.
export const professionStatusConfig = Object.freeze({
...
export const DEFAULT_INCLUDED_STATUSES = Object.freeze(["active"]);
...
const professionSeeds = [
  ...
  {
    id: "inzeniersistemu_buvtehnikis",
    title: "Inženiersistēmu būvtehniķis",
    sector: "Būvniecība",
    description:
      "Vēsturiskajā VTDT piedāvājumā profesija bija saistīta ar ēku inženiersistēmu izbūves plānošanu, montāžas darba organizēšanu un pārbaudi.",
    tasks: [
      "lasīt ēku inženiersistēmu shēmas un rasējumus",
      "plānot cauruļvadu, iekārtu un mezglu montāžas secību",
      "pārbaudīt sistēmas izbūvi, mērījumus un darbību",
    ],
    workEnvironment:
      "Būvobjekts un tehniskās telpas, sadarbojoties ar citiem būvniecības speciālistiem; statuss katalogā ir vēsturisks.",
    aspects: [
      "izprast ēkā paslēptu sistēmu kopdarbību",
      "savienot shēmu lasīšanu ar pārbaudi objektā",
      "koordinēt tehniski secīgu montāžas procesu",
    ],
    challenge:
      "Sistēmas ir savstarpēji saistītas, tādēļ kļūda shēmā, montāžā vai pārbaudē var ietekmēt visu ēku.",
    learningTask:
      "Pēc vienkāršotas shēmas izplānot ūdens vai apkures mezgla detaļas, montāžas secību un pārbaudes punktus.",
    officialUrl: VTDT_SOURCES.openDays2025,
    sourceUrl: VTDT_SOURCES.openDays2025,
    profile: createProfile({
      realistic: 0.85,
      investigative: 0.8,
      artistic: 0.2,
  ...
  {
    id: "atjaunojamas_energetikas_tehnikis",
    title: "Atjaunojamās enerģētikas tehniķis",
    sector: "Enerģētika",
    description:
      "Vēsturiskajā VTDT piedāvājumā profesija bija saistīta ar atjaunojamās enerģijas iekārtu montāžu, pārbaudi un apkopi.",
    tasks: [
      "izvērtēt enerģijas iekārtas izvietojumu un pieslēguma shēmu",
      "montēt un konfigurēt sistēmas komponentes",
      "veikt mērījumus, apkopi un darbības pārbaudi",
    ],
    workEnvironment:
      "Tehniski objekti telpās un ārā, bieži sadarbojoties komandā; statuss pašreizējā VTDT katalogā ir vēsturisks.",
    aspects: [
      "savienot elektrību ar reālu enerģijas ieguves sistēmu",
      "strādāt gan ar shēmām, gan iekārtām objektā",
      "mērīt un uzlabot tehniskas sistēmas darbību",
    ],
    challenge:
      "Montāža var notikt ārā un augstumā; laikapstākļi, drošība un vairāku sistēmas daļu saskaņošana prasa disciplīnu.",
    learningTask:
      "Izveidot nelielas saules paneļa sistēmas savienojumu shēmu, samontēt mācību stendu un salīdzināt mērījumus dažādos apstākļos.",
    officialUrl: VTDT_SOURCES.openDays2025,
    sourceUrl: VTDT_SOURCES.openDays2025,
    profile: createProfile({
      realistic: 0.85,
      ...
      enterprising: 0.65,
      conventional: 0.85,
      mechanicsDiagnostics: 0.4,
      electricityEnergy: 0.95,
      spatialDrawing: 0.45,
      constructionCoordination: 0.5,
      precisionPatience: 0.85,
      physicalWork: 0.75,
      outdoorWork: 0.9,
      teamwork: 0.8,
      independentFocus: 0.55,
    }),
  },
];

const statusById = Object.fromEntries(
  Object.entries(professionStatusConfig).flatMap(([status, ids]) =>
...
export const professions = Object.freeze(
  professionSeeds.map((profession) =>
    Object.freeze({
      ...profession,
      status: statusById[profession.id] ?? "unverified",
...
export const getProfessionsByStatus = (statuses = DEFAULT_INCLUDED_STATUSES) => {
  const included = new Set(statuses);
  return professions.filter((profession) => included.has(profession.status));
};
